 ...
 * start and the end of the ith interval and intervals is sorted in ascending order by starti. You are also given an interval newInterval = [start, end]
...
public class InsertInterval {
    public int[][] insert(int[][] intervals, int[] newInterval) {
        ...
        int i = 0;
        //add intervals before current interval start
