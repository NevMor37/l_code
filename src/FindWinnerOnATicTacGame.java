 ...
 */
public class FindWinnerOnATicTacGame {
    public String tictactoe(int[][] moves) {
        int antiScore = 0, diaScore = 0;
        ...
        if(antiScore == 3) return "A";
        else if(antiScore == -3) return "B";
        if(diaScore == 3) return "A";
        else if(diaScore == -3) return "B";
        for(int row : rowScore) {
            if(row == 3) return "A";
            else if(row == -3) return "B";
        }
        for(int col : colScore) {
            if(col == 3) return "A";
